...
<html>
    ...
    <body>
        ...
        <div class="tabHeader"> 
            <center>
                <spring:message code="candidateperinfo.title"/>
            </center>
        </div>
        <div class="tabContent">
            <br>
            <div class="viewPI">
                 <c:if test="${!candidateByStreamPLH.firstPage}">
                    <a id="placedPrev" href="showcandidatebystream.html?page=previous"><b>&lt;&lt; Prev</b></a>
                </c:if>
                <c:if test="${!candidateByStreamPLH.lastPage}">
                    <a  id="placedNext" href="showcandidatebystream.html?page=next"><b>Next &gt;&gt;</b></a>
                </c:if> 
                <table id="candidatedataTable" class="viewPI">
                    ...
                    <c:forEach var="candidate" items="${candidateByStreamPLH.pageList}">
                        <tr>
