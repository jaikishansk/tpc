...
<html>
    ...
    <body>
        ...
        <div class="tabContent">
            <br>
            <div class="viewPI">
                 <c:if test="${!candidateByDegreePLH.firstPage}">
                    <a id="placedPrev" href="showcandidatebydegree.html?page=previous"><b>&lt;&lt; Prev</b></a>
                </c:if>
                <c:if test="${!candidateByDegreePLH.lastPage}">
                    <a  id="placedNext" href="showcandidatebydegree.html?page=next"><b>Next &gt;&gt;</b></a>
                </c:if> 
                <table id="candidatedataTable" class="viewPI">
                    ...
                    <c:forEach var="candidate" items="${candidateByDegreePLH.pageList}">
                        <tr>
