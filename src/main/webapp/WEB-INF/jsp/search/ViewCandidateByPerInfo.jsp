...
<html>
    ...
    <body>
        ...
        <div class="tabContent">
            <br>
            <div class="viewPI">
                 <c:if test="${!personalInfoPLH.firstPage}">
                    <a id="placedPrev" href="showcandidatebyperinfo.html?page=previous"><b>&lt;&lt; Prev</b></a>
                </c:if>
                <c:if test="${!personalInfoPLH.lastPage}">
                    <a  id="placedNext" href="showcandidatebyperinfo.html?page=next"><b>Next &gt;&gt;</b></a>
                </c:if> 
                <table id="candidatedataTable" class="viewPI">
                    ...
                    <c:forEach var="candidate" items="${personalInfoPLH.pageList}">
                        <tr>
