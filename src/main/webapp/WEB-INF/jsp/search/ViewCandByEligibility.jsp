...
<html>
    ...
    <body>
        ...
        <div class="tabContent">
            <br>
            <div class="viewPI">
                 <c:if test="${!eligibilityPLH.firstPage}">
                    <a id="placedPrev" href="showcandidatebyeligibility.html?page=previous"><b>&lt;&lt; Prev</b></a>
                </c:if>
                <c:if test="${!eligibilityPLH.lastPage}">
                    <a  id="placedNext" href="showcandidatebyeligibility.html?page=next"><b>Next &gt;&gt;</b></a>
                </c:if> 
                <table id="candidatedataTable" class="viewPI">
                    ...
                    <c:forEach var="candidate" items="${eligibilityPLH.pageList}">
                        <tr>
