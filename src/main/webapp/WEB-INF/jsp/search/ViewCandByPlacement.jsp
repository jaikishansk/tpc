<%-- 
    Document   : ViewCandByPlacement.jsp
...
<html>
    ...
    <body>
        ...
        <div class="tabHeader">
            <center>
                <spring:message code="candidateplacementinfo.title"/>
            </center>
        </div>
        <div class="tabContent">
            <br>
            <div class="viewPI">
                 <c:if test="${!candidateByPlacementPLH.firstPage}">
                    <a id="placedPrev" href="showcandbyplacement.html?page=previous"><b>&lt;&lt; Prev</b></a>
                </c:if>
                <c:if test="${!candidateByPlacementPLH.lastPage}">
                    <a  id="placedNext" href="showcandbyplacement.html?page=next"><b>Next &gt;&gt;</b></a>
                </c:if> 
                <table id="candidatedataTable" class="viewPI">
                    ...
                    <c:forEach var="candidate" items="${candidateByPlacementPLH.pageList}">
                        <tr>
