...
<html>
    ...
    <body>
        ...
        <div class="tabHeader">
            <center>
                <spring:message code="candidatecd.title"/>
            </center>
        </div>
        <div class="tabContent">
            <br>
            <div class="viewPI">
                 <c:if test="${!contactPLH.firstPage}">
                    <a id="placedPrev" href="showcandidatebycontact.html?page=previous"><b>&lt;&lt; Prev</b></a>
                </c:if>
                <c:if test="${!contactPLH.lastPage}">
                    <a  id="placedNext" href="showcandidatebycontact.html?page=next"><b>Next &gt;&gt;</b></a>
                </c:if> 
                <table id="candidatedataTable" class="viewPI">
                    ...
                    <c:forEach var="candidate" items="${contactPLH.pageList}">
                        <tr>
