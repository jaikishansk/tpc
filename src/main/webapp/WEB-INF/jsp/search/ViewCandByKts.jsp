<%-- 
    Document   : ViewCandidateByPerInfo
...
<html>
    ...
    <body>
        ...
        <div class="tabHeader"> 
            <center>
                <spring:message code="candidatekts.title"/>
            </center>
        </div>
        <div class="tabContent">
            <br>
            <div class="viewPI">
                 <c:if test="${!candidateByKTsPLH.firstPage}">
                    <a id="placedPrev" href="showcandidatebykts.html?page=previous"><b>&lt;&lt; Prev</b></a>
                </c:if>
                <c:if test="${!candidateByKTsPLH.lastPage}">
                    <a  id="placedNext" href="showcandidatebykts.html?page=next"><b>Next &gt;&gt;</b></a>
                </c:if> 
                <table id="candidatedataTable" class="viewPI">
                    ...
                    <c:forEach var="candidate" items="${candidateByKTsPLH.pageList}">
                        <tr>
                            <td>${candidate.candidateId}</td>
                            <td>${candidate.firstName}</td>
                            <td>${candidate.lastName}</td>
                            <td>${candidate.liveKT}</td>
                            <td>${candidate.pastKT}</td>
                            <td>${candidate.KTSubjects}</td>
